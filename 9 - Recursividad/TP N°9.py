...
print(f"¿La palabra {palabra} es palindromo? {es_palindromo(palabra,izquierda,derecha)}")
...
while n < 1:
    ...
    n = int()
print(f"La cantidad total de bloques que necesita para contruir la pirámide es de: {contar_bloques(n)}")
...
while digit < 1 or digit > 10:
    ...
    digit = int()
print(f"La cantidad de veces que aparece {digit} en {n} es: {contar_digito(n,digit)}")